...
const drawDebit = async (canvas, ctx, saleInfo, logoImage, qrCodeImage) => {
    let y = 0;
    ...
    ctx.fillRect(0, y, CANVAS_SETTINGS.canvasWidth, CANVAS_SETTINGS.lineHeight);
    ctx.fillStyle = "black";
    drawText("Simplified Debit Note / إشعار مدين مبسط", CANVAS_SETTINGS.smallFontSize - 2, 'center', CANVAS_SETTINGS.lineHeight / 2, true);
    y += 15;
    y += 15;
    ...
    ctx.textAlign = "left";
    ctx.fillText(`${saleInfo.debit_no}`, CANVAS_SETTINGS.paddingX, y + CANVAS_SETTINGS.lineHeight / 2 + 5);
    ...
    ctx.textAlign = "left";
    ctx.fillText(`${saleInfo.debit_date} ${saleInfo.debit_time_inv}`, CANVAS_SETTINGS.paddingX, y + CANVAS_SETTINGS.lineHeight / 2 + 5);
